...
# batch_sizes=('128')
micro_batch_sizes=('1')
learning_rates=('0.0008' '0.0003')
weight_decays=('0.01')
# lr_types=('CosineAnnealingLR')
lr_types=('Fix')
warmup_steps='100'
dirs=('out/Llama-2-13b-hf/limaoasst/lora_swa_r8a16_AdamW/bnb.nf4-dq/Fix/2023-10-26')
...
### 実行するとき
# CUDA_VISIBLE_DEVICES=7 nohup bash sh/llama_swa_r8a16_quantize.sh >sh_logs/llima_swa_r8a16_quantize_1053.log 2>sh_logs/error_swa_r8a16_quantize_1053.log &